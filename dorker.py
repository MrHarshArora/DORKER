...
import string, sys, time, urllib2, cookielib, re, random, threading, socket, os, subprocess, browser
...
def logo():
	print R+"\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
	print ">		 ____   ___       _    _____ ____ 		 >"
	print ">		|  _ \ / _ \ _ __| | _|___ /|  _ \		 >"
	print ">		| | | | | | | '__| |/ / |_ \| |_) |		 >"
	print ">		| |_| | |_| | |  |   < ___) |  _ < 		 >"
	print ">		|____/ \___/|_|  |_|\_\____/|_| \_\		 >"
	print ">								 >"
        print ">		         D0rk3r f0r SQli          		 >"
        print ">    		     <<<<<<WITCHER>>>>>>>>       		 >"
        print ">    		      find me on instagram                        >"
        print ">   		  https://www.instagram.com/w17ch3r__/            >"  
        print ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n"
	print W
...
domains = {'All domains':['ac', 'ad', 'ae', 'af', 'ag', 'ai', 'al', 'am', 'an', 'ao',
	...
	'Default':['com','biz','net','edu','co','org','us','gov','info'],
	'Special (in,pk)': ['in','pk'],
	'Choose specific domain':[''],
	'TLD':['xxx','edu', 'gov', 'mil','biz', 'cat', 'com', 'int','net', 'org', 'pro', 'tel', 'aero', 'asia','coop', 'info', 'jobs', 'mobi', 'name', 'museum', 'travel']}
